...
int main() {
  ...
  */
  // for (int run=startrun;run<=endrun;run++){
    ...
    // eventNumber=293;
    //eventNumber=286;
    //eventNumber=608;//CW2, p2p/100 = 13;
    //eventNumber=130;
    //eventNumber=1;
    // eventNumber=15;
    // eventNumber=14;
    //eventNumber=6004;
    // eventNumber=4661;//currently fails ratio cut, peak-2-peak >400 mV
    //eventNumber=14243;
    //eventNumber=2278;
    //eventNumber=324;
  ...
  //MyCorrelator *magicPtr = new MyCorrelator("/u/home/agoodhue/icemcEventMaker/runs",run, WaveCalType::kDefault);
    ...
    // MyCorrelator *magicPtr = new MyCorrelator("/data/anita/btdailey/icemc_events/no_noise",run, WaveCalType::kDefault);
    MyCorrelator *magicPtr = new MyCorrelator("/data/anita/btdailey/icemc_events/20noise",run, WaveCalType::kDefault);
