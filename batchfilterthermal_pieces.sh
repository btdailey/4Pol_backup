...
do
	...
	do
		...
		let "start_number=i";
		qsub runfilterthermal_pieces.sh -v RUNNUMBER=$h,FILENAME=$FILENAMER,FILTER=$filter_number,PHASE=$phase_number,SIMFILE=$start_number,start_number=$start_number,end_number=$end_number;
