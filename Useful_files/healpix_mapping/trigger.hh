...
public:
    ...
    void GetArrivalTimes(int inu,Balloon *bn1, const Vector &rf_direction);
    ...
    double arrival_times[Anita::NLAYERS_MAX*Anita::NPHI_MAX];
    ...
    unsigned int first_phi_sector_hit; // This is used by the coherent waveform sum trigger scheme to make processing more efficient
    double three_bit_round(double input);
...
public:
  ...
  void L1Trigger(Anita *anita1,double timedomain_output_1[5][Anita::NFOUR],double timedomain_output_2[5][Anita::NFOUR],int minsample,const int NSAMPLES,double *powerthreshold,double *bwslice_rmsdiode,double l1window,double TIMESTEP,int *channels_passing_e_forglob,int *channels_passing_h_forglob,int &npass);
