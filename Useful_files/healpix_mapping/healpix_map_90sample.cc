...
int main(int argc, char **argv) {
  ...
  string temp = "/data/anita/btdailey/passingCuts/90sample_partial_passedcuts_0301_HPol.root";
  char *rootfile;
  ...
  //then use ang2pix  to get pix, add event to Base[pixel]
	...
	Lons_boundary1.push_back(Lons_boundary1_tmp);
      ...
      int polarization=1;//0==VPol, 1 = Hpol
	...
	//point_boundaries[j]->Draw("same");
      ...
      c2->Print("healpix_map_0301_90_HPol.png");
      c2->Print("healpix_map_90_HPol.eps");
