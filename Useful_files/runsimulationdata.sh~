...
mkdir -p /tmp/sim/$FILTER/$PHASE/$FILENAME

FILENAMER=/tmp/sim/$FILTER/$PHASE/$FILENAME

cd /home/dailey.110/analysis_oindree
source /home/dailey.110/.bash_profile

./loopsimulationdata $RUNNUMBER $FILENAMER $FILTER $PHASE
...
cp /tmp/sim/$FILTER/$PHASE/$FILENAME/output* /data/anita/btdailey/final_filter/$PHASE_DIR/$OUTPUT_DIR
#mv $LOCAL_DIR/tmp/$CWDIR/$FILTER/$FILENAME/output* /data/anita/dailey.110/filter_study/saturated/noCW
rm -rf /tmp/sim/$FILTER/$PHASE/
