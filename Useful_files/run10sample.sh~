...
mkdir -p /tmp/10sample/$FILTER/$PHASE/$FILENAME

FILENAMER=/tmp/10sample/$FILTER/$PHASE/$FILENAME
...
cp /tmp/10sample$FILTER/$PHASE/$FILENAME/output* /data/anita/btdailey/final_filter/$PHASE_DIR/$OUTPUT_DIR
#mv $LOCAL_DIR/tmp/$CWDIR/$FILTER/$FILENAME/output* /data/anita/dailey.110/filter_study/saturated/noCW
rm -rf /tmp/10sample/$FILTER/$PHASE/$FILENAME
