...
LIBS          = -L/home/dailey.110/analysis_oindree/ -L/data/anita/btdailey/Healpix_stuff/cfitsio/lib -L/home/dailey.110/Healpix_3.30/lib -L/home/dailey.110/Healpix_3.30/src/cxx/generic_gcc/lib $(ROOTLIBS) -lchealpix -lcfitsio -lMathMore -lMinuit -L/data/anita/btdailey/analysis_info/data $(SYSLIBS) $(LD_ANITA_UTIL) $(FFTLIBS) -L$(ANITA_ANALYSIS_HOOVER)
GLIBS         = $(ROOTGLIBS) $(SYSLIBS)

#Now the bits we're actually compiling
ROOT_LIBRARY = libMyCorrelator_oindree.${DLLSUF}
LIB_OBJS =MyCorrelator.o corrDict.o
CLASS_HEADERS = MyCorrelator.h analysis_info_4pol.h
#EXE = ssEventMaker
