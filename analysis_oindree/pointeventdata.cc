...
int main() {
  ...
  char filename[150];
    ...
    sprintf(filename,"Passed_events_90sample_tester.root");
  
  TFile *rootfile_out = new TFile (filename,"RECREATE");

  TTree *passing_events_tree = new TTree("passing_events","passing_events");
  passing_events_tree->Branch("pol4_Ptr",&pol4_Ptr); 
  ...
  */
  // for (int run=startrun;run<=endrun;run++){
    ...
    // int eventNumber_array[24]={830693,5276383,7421818,7460738,8306117,8370486,8381355,8394834,8456337,8456989,11199059,12233576,16025033,18538216,18543601,18543731,18543760,18543785,18543833,23191802,23350827,23358924,25887362,26009469};
    //int run_array[24] = {14,50,63,63,71,74,75,75,76,76,109,120,155,168,168,168,168,168,168,225,226,227,250,251};

    //int eventNumber_array[40]={830693,4787105,5276383,7382414,7405516,7421818,7460738,7486629,8099585,8306117,8370486,8381355,8394834,8456337,8456989,8527491,8529722,8529726,8529903,8532837,11199059,12233576,16024399,16025033,18523070,18523574,18524721,18538216,18543601,18543731,18543760,18543785,18543833,18561517,23191802,23350827,23358924,23434742,25887362,26009469};
    //int run_array[40] = {14,44,50,63,63,63,63,63,68,71,74,75,75,76,76,77,77,77,77,77,109,120,155,155,168,168,168,168,168,168,168,168,168,168,225,226,227,227,250,251};
   
    //int eventNumber_array[10]={12056599,23948872,23948864,23948587,12056523,12050348,23958771,23948490,12080027,23933251};

    //VPOL Passing events
    int eventNumber_array[3] = {830693,11199059,12233576};
    int run_array[3]={14,109,120};

    //HPOL Passing event
    //int eventNumber_array[4] = {7486629,8099585,18561517,23434742};
    //int run_array[4] = {63,68,168,227};

    //int run_array[10]={118,231 ,231 ,231 ,118,118,232 ,231 , 119,231}; 
    //HPOL 7,8,33,37
