...
int main() { 
   ...
   TH2D *hcross_corr_LR_corrected = new TH2D("cross_Cor LR c",";Correlation Value;Peak Hilbert Value (mv)",200,0,1,500,0,200E6);
   ...
   vector<double> weight_tracker(numbins/index_mult,0.);
    ...
    angle_cut_ctr=0;
     ...
     string temp = "/data/anita/btdailey/final_filter/10sample/geom_4pol/output12_0.root";
   ...
   for(int runno=1;runno<=1;runno++){
     ...
     char *rootfile = Form(temp.c_str());
       ...
       for(int extra=13;extra<262;extra++){
	 
	 for(int delta=0;delta<30000;delta+=1000){
	   
	   sprintf(rootfile,"/data/anita/btdailey/final_filter/10sample/geom_4pol/output%d_%d.root",extra,delta);
...
// TH2D  *haxes = new TH2D("axes","SNR peak After Filter; Peak-to-Peak; #frac{# passing cuts}{# passing trigger}",numbins/index_mult,0,numbins,15,0,1.1);
 ...
 sprintf(printer,"/home/dailey.110/analysis_oindree/efficiency_10sample.png");
 c1->Print(printer);
...
TCanvas *c2 = new TCanvas("c2","c2",800,800);
 ...
 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_dist_10sample.png");
 c2->Print(printer);

TCanvas *c3 = new TCanvas("c3","c3",800,800);
 hfilterbins->Draw();

 sprintf(printer,"/home/dailey.110/analysis_oindree/filterbins_10sample.png");
 c3->Print(printer);

 TCanvas *c5 = new TCanvas("c5","c5",800,800);
 hcross_corr_cut->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_cut_10sample.png");
 c5->Print(printer);

 TCanvas *c6 = new TCanvas("c6","c6",800,800);
 hcross_corr_cut_corrected->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_cut_corrected_10sample.png");
 c6->Print(printer);

TCanvas *c10 = new TCanvas("c10","c10",800,800);
 hdistance->Draw();

 sprintf(printer,"/home/dailey.110/analysis_oindree/distance_10sample.png");
 c10->Print(printer);
...
TCanvas *c6a = new TCanvas("c6a","c6a",800,800);
 ...
 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_cut_corrected_zoomed_10sample.png");
 c6a->Print(printer);
 ...
 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_cut_zoomed_10sample.png");
 c5a->Print(printer);

TCanvas *c7 = new TCanvas("c7","c7",800,800);
 hcross_corr_LR->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_LR_10sample.png");
 c7->Print(printer);
...
TCanvas *c7a = new TCanvas("c7a","c7a",800,800);
 ...
 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_LR_zoomed_10sample.png");
 c7a->Print(printer);

TCanvas *c7b = new TCanvas("c7b","c7b",800,800);
 hcross_corr_LR_corrected->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_LR_corrected_10sample.png");
 c7b->Print(printer);
...
TCanvas *c7c = new TCanvas("c7c","c7c",800,800);
 ...
 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_LR_zoomed_corrected_10sample.png");
 c7c->Print(printer);
...
TCanvas *c8 = new TCanvas("c8","c8",800,800);
 ...
 sprintf(printer,"/home/dailey.110/analysis_oindree/deltaTheta_LR_10sample.png");
 c8->Print(printer);

TCanvas *c9 = new TCanvas("c9","c9",800,800);
 hdeltaPhi->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/deltaPhi_LR_10sample.png");
 c9->Print(printer);

TCanvas *c11 = new TCanvas("c11","c11",800,800);
 hcross_corr_cut_SNR->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_cut_SNR_10sample.png");
 c11->Print(printer);
...
sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_cut_SNR_zoomed_10sample.png");
 c11a->Print(printer);

TCanvas *c12 = new TCanvas("c12","c12",800,800);
 hcross_corr_LR_SNR->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_LR_SNR_10sample.png");
 c12->Print(printer);
...
sprintf(printer,"/home/dailey.110/analysis_oindree/cross_corr_LR_SNR_zoomed_10sample.png");
 c12a->Print(printer);
...
TCanvas *c13 = new TCanvas("c13","c13",800,800);
 hpeakLvsR->Draw("zcol");
 line->Draw("same");
 sprintf(printer,"/home/dailey.110/analysis_oindree/peakLvsR_10sample.png");
 c13->Print(printer);

TCanvas *c14 = new TCanvas("c14","c14",800,800);
 hpeaksratio->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/peaksratio_10sample.png");
 c14->Print(printer);

TCanvas *c15 = new TCanvas("c15","c15",800,800);
 hcorrratio->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/corrratio_10sample.png");
 c15->Print(printer);

TCanvas *c16 = new TCanvas("c16","c16",800,800);
 hintegrandvsSNR->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/integrandSNR_10sample.png");
 c16->Print(printer);

TCanvas *c17 = new TCanvas("c17","c17",800,800);
 hdenomvsSNR->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/denomSNR_10sample.png");
 c17->Print(printer);

TCanvas *c18 = new TCanvas("c18","c18",800,800);
 hCorrvstime->Draw("zcol");

 sprintf(printer,"/home/dailey.110/analysis_oindree/Corrtime_10sample.png");
 c18->Print(printer);
