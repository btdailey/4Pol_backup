  ...
  */
  ...
  TMarker *eventPos[18];
    ...
    int whichPol=0;
     ...
     TH2D *hevents = new TH2D("events",";Peak Value;SNR",10000,0,1,1000,0,200);
	...
	whichPol=1;
      ...
      cout<<"peakVal, SNR is "<<pol4_Ptr->peakVal[whichPol]<<" "<<pol4_Ptr->SNR_coherent[whichPol]<<"\n";
	...
	myfile<<eventNumber<<"\t"<<pol4_Ptr->ratioFirstToSecondPeak[whichPol]<<"\t"<<pol4_Ptr->peakVal[whichPol]<<"\t"<<pol4_Ptr->peakHilbertCoherent[whichPol]<<"\t"<<pol4_Ptr->thetaMap[whichPol]<<"\t"<<pol4_Ptr->polFractionCoherent[whichPol]<<"\t"<<pol4_Ptr->eventTracedFlag[whichPol]<<"\t"<<pol4_Ptr->hwTriggerFlag[whichPol]<<"\t"<<pol4_Ptr->varnerFlag[whichPol]<<"\t"<<pol4_Ptr->SNR_coherent[whichPol]<<"\t"<<pixel_num<<"\n";
      ...
      hevents->Fill(pol4_Ptr->peakVal[whichPol],pol4_Ptr->SNR_coherent[whichPol]);
      eventPos[i] = new TMarker(pol4_Ptr->peakVal[whichPol],pol4_Ptr->SNR_coherent[whichPol],5);
    ...
    TLine *line1 = new TLine(0.,13.55,.357,0.);//3069
    TLine *line2 = new TLine(0.,23.65,.622,0.);//3033

    TLine *line3 = new TLine(0.,142.,1.,104.);//3051

    TLine *line4 = new TLine(0.,14.25,14.25/38.,0.);
    TLine *line5 = new TLine(0.,17.45,17.45/28,0.);
    
    TLine *line6 = new TLine(0.,22.55,22.55/38,0.);
    
    TLine *line7 = new TLine(0.,20.45,20.45/38,0.);
    TLine *line8 = new TLine(0.,15.15,15.15/38,0.);
    
    TLine *line9 = new TLine(0.,18.05,18.05/38.,0.);
    TLine *line10 = new TLine(0.,15.25,15.25/28,0.);
    
    TLine *line11 = new TLine(0.,22.35,22.35/38,0.);
    
    TLine *line12 = new TLine(0.,16.85,16.85/38,0.);
    TLine *line13 = new TLine(0.,17.05,17.05/38,0.);
    
    TLine *line14 = new TLine(0.,18.85,18.85/38,0.);
    
    TLine *line15 = new TLine(0.,13.95,13.95/38,0.);
    TLine *line16 = new TLine(0.,13.55,13.55/38,0.);
    ...
    line1->SetLineWidth(2);
	 ...
	 eventPos[i]->Draw("same");
       ...
       c0->Print("Brian_comparison_events.png");
       myfile.close();
}//main
//}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
