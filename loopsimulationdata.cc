...
int main(int argc, char **argv) {
  ...
  int delta=1;
  MyCorrelator *magicPtr = new MyCorrelator("/data/anita/btdailey/icemc_events/Kotera_max3",run, WaveCalType::kDefault);
  ...
  //magicPtr->loopOverEvents(0,10000000,0,0,0,0,current_dir,filter_number,phase_number);//do taylor dome events 1000000

  //magicPtr->loopOverEvents(0,3000,0,0,0,0,current_dir,filter_number,phase_number);//do taylor dome events 1000000

  //magicPtr->loopOverEvents(3001,6000,0,0,0,0,current_dir,filter_number,phase_number);//do taylor dome events 1000000

  //magicPtr->loopOverEvents(6001,9000,0,0,0,0,current_dir,filter_number,phase_number);//do taylor dome events 1000000

  //magicPtr->loopOverEvents(9001,20000,0,0,0,0,current_dir,filter_number,phase_number);//do taylor dome events 1000000
